    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mr-5">Merchandise</h5>
                <!--end::Title-->
            </div>
            <!--end::Details-->
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-custom gutter-b">
                        <div class="card-body">
                            <form id="filter_content" enctype="multipart/form-data" method="post" action="/merchandise/store">
                                @csrf
            ...
            @foreach ($merchandises as $item)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/merchandise/delete/{{ $item->id }}" class="btn btn-danger float-right mr-2">
...
<script>
    function edit(id){
        var url = '/merchandise/show/'+id;
        var link = '/merchandise/update/'+id;
        $.ajax({
            url : url,
            method: 'get',
